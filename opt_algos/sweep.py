...
COLORS = {
    ...
    'RandomSearch': 'blue',
    'GridSearch': 'green', 
    # "Pseudo": 'orange',  # Added Pseudo
    "MS_PseudoBO": 'pink',  # Added Pseudo
}
