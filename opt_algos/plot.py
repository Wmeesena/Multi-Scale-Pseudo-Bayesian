...
COLORS = {
    ...
    'RandomSearch': 'blue',
    'GridSearch': 'green',
    'SMAC_RF_LCB_beta1.0': 'orange',
    'SMAC_RF_PI': 'purple',
    'SMAC_GP_LCB_beta1.0': 'cyan',
    'SMAC_GP_EI': 'magenta',
    'SMAC_GP_PI': 'brown',
}
...
def create_optimization_plot(results, metric, metric_name, seeds):
    ...
    # For each optimizer
    for opt_name in ['SMAC_RF_EI', 'RandomSearch', 'GridSearch', 'SMAC_RF_LCB_beta1.0', 'SMAC_RF_PI', 'SMAC_GP_LCB_beta1.0', 'SMAC_GP_EI', 'SMAC_GP_PI']:
...
def main():
    ...
    # Load the results
    results_file = os.path.join(results_dir, "data", "optimization_results_new.pickle")
    ...
    if args.output_dir:
        ...
        output_dir = os.path.join(results_dir, "plots_new")
